...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 구매 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_tb` VALUES (1,1,12,'16','2023-11-08','서울 종로구 북촌로 31-4','북촌',3055),(2,2,12,'10','2023-11-11','부산 강서구 가달1로 7','강서구',46729),(3,1,7,'16','2023-11-11','부산 강서구 경등중앙길 140','부산주소테스트',46717),(4,2,7,'17','2023-11-09','서울 강남구 가로수길 5','강남 가로수길',6035);
...
INSERT INTO `payment_tb` VALUES (1,1,1,159000,'주문접수대기중','2023-11-06'),(2,2,2,82400,'주문접수대기중','2023-11-06'),(3,3,1,240000,'주문접수','2023-11-06'),(4,4,2,63000,'주문접수대기중','2023-11-06');
...
-- Dump completed on 2023-11-06 18:49:07
