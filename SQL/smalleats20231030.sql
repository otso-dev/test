...
INSERT INTO `authority_tb` VALUES (1,1,1,NULL),(2,2,1,NULL),(3,3,1,NULL),(4,4,1,NULL),(5,5,1,NULL),(6,6,1,NULL),(7,7,1,NULL),(8,8,1,NULL),(9,0,2,1),(10,0,2,NULL),(11,0,2,3),(12,0,2,4),(13,0,2,5),(16,9,3,0),(17,10,3,0),(18,11,3,0),(19,12,1,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='음식점 카테고리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `category_tb` VALUES (1,'족발'),(2,'패스트푸드');
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='배달 가능 구역';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `food_delivery_tb` VALUES (1,1,'동래구'),(2,1,'사상구'),(3,1,'남구'),(4,1,'북구'),(5,1,'해운대구'),(6,2,'수영구'),(7,2,'해운대구'),(8,2,'연제구'),(9,3,'기장군'),(10,3,'사상구'),(11,3,'수영구'),(12,0,'동래구'),(13,1,'수영구'),(14,1,'중구'),(15,2,'기장군'),(16,2,'북구'),(17,2,'강서구'),(18,2,'부산진구'),(19,2,'영도구');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='음식점 메뉴 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `food_menu_tb` VALUES (1,1,'음식점 1의 메뉴 1',NULL,'5000'),(2,1,'음식점 1의 메뉴 2',NULL,'6000'),(3,1,'음식점 1의 메뉴 3',NULL,'7000'),(4,2,'음식점 2의 메뉴1',NULL,'10000'),(5,2,'음식점 2의 메뉴3',NULL,'15000'),(6,3,'음식점 3의 메뉴1',NULL,'20000'),(7,3,'음식점 3의 메뉴5',NULL,'25000'),(8,1,'족발 소자',NULL,'20000'),(9,1,'족발 (中)자',NULL,'30000'),(10,1,'족발 (大)자',NULL,'40000'),(11,2,'불고기버거',NULL,'2000'),(12,2,'빅맥',NULL,'4400');
...
INSERT INTO `food_tb` VALUES (1,0,'귀족향 동래점',NULL,'11','12','30000','3000','부산','부산 동래구 미남로 11','귀족향 동래점',47845),(2,0,'맥도날드 서면점',NULL,'0','24','10000','3000','부산','부산 부산진구 중앙대로692번길 33','맥도날드 서면3호점',47295),(3,0,'음식점3',NULL,'10','10','25000','4000','',NULL,NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='구매 메뉴 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_menu_tb` VALUES (1,1,4,1),(2,1,5,1),(3,1,11,2),(4,1,12,2),(5,2,8,6),(6,2,9,6),(7,3,6,6),(8,3,7,10),(9,4,9,6),(10,4,10,7),(11,5,11,20),(12,6,6,6),(13,6,7,5),(14,7,11,4),(15,7,12,4),(16,8,5,4),(17,8,11,7),(18,8,12,6);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 구매 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_tb` VALUES (1,2,8,'11','2023-10-27'),(2,1,8,'23','2023-10-28'),(3,3,8,'17','2023-10-31'),(4,1,7,'19','2023-10-27'),(5,2,7,'11','2023-10-27'),(6,3,7,'19','2023-10-28'),(7,2,12,'13','2023-11-01'),(8,2,7,'11','2023-10-31');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='파트너 회원 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment_tb` VALUES (1,1,2,40800,'주문접수대기중'),(2,2,1,303000,'배달완료'),(3,3,3,374000,'주문접수'),(4,4,1,463000,'배달완료'),(5,5,2,43000,'주문접수대기중'),(6,6,3,249000,'주문접수'),(7,7,2,28600,'배달중'),(8,8,2,103400,'주문접수');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='음식점 등록 전 임시 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pending_food_tb` VALUES (2,1,0,'귀족향 동래점',NULL,11,12,30000,3000,'부산','부산 동래구 미남로 11','귀족향 동래점',47845,1,'APPROVED'),(3,2,0,'맥도날드 서면점',NULL,0,24,10000,3000,'부산','부산 부산진구 중앙대로692번길 33','맥도날드 서면3호점',47295,3,'APPROVED');
...
INSERT INTO `user_address_tb` VALUES (1,2,'경북 안동시 강남1길 49','테스트3',36751,NULL,NULL,NULL),(2,2,'경북 경주시 남산순환로 12-5','테스트2',38174,NULL,NULL,NULL),(4,2,'서울 강남구 가로수길 5','강남살기',6035,NULL,NULL,NULL),(5,3,'부산 사상구 가야대로 1','사직운동장',46990,NULL,NULL,NULL),(6,6,'경기 성남시 분당구 대왕판교로 477','판교에서 살아보기',13480,NULL,NULL,NULL),(8,8,'부산 강서구 거가대로 2571','테스트 주소',46770,'부산','강서구',NULL),(9,7,'서울 종로구 북촌로 31-4','테스트 주소2',3055,'서울','종로구',NULL),(10,12,'서울 종로구 북촌로 31-4','북촌',3055,'서울','종로구',NULL);
...
-- Dump completed on 2023-10-30  1:57:25
