...
INSERT INTO `authority_tb` VALUES (1,1,1,0),(2,2,1,0),(3,3,1,0),(4,4,1,0),(5,5,1,0),(6,6,1,0),(7,7,1,0),(8,8,1,0),(9,0,2,1),(10,0,2,2),(11,0,2,3),(12,0,2,4),(13,0,2,5),(18,11,3,0),(19,12,1,0),(20,0,2,6),(21,13,1,0),(22,0,2,7);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='음식점 카테고리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `food_tb` (
  ...
  `food_road_address` varchar(30) DEFAULT NULL COMMENT '음식점 도로명 주소',
  `food_detail_address` varchar(20) DEFAULT NULL COMMENT '음식점 상세주소',
  `food_zonecode` int DEFAULT NULL,
  `food_address_sigungu` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`food_id`)
...
INSERT INTO `food_tb` VALUES (1,3,'귀족향 동래점',NULL,'11','12','30000','3000','부산','부산 동래구 미남로 11','귀족향 동래점',47845,'동래구'),(2,2,'맥도날드 서면점',NULL,'0','12','10000','3000','부산','부산 부산진구 중앙대로692번길 33','맥도날드 서면3호점',47295,'부산진구'),(3,2,'롯데리아 롯데마트 동래점',NULL,'10','22','10000','3000','부산','부산 동래구 중앙대로 1393','롯데리아 롯데마트 동래점',47727,'동래구'),(4,5,'각방',NULL,'11','20','12000','5000','부산','부산 부산진구 동천로107번길 12-5','각방',47246,'부산진구'),(5,5,'페이센동',NULL,'11','20','15000','3000','부산','부산 부산진구 서전로46번길 6','페이센동 전포본점',47293,'부산진구');
...
CREATE TABLE `order_menu_tb` (
  ...
  CONSTRAINT `order_id` FOREIGN KEY (`order_id`) REFERENCES `order_tb` (`order_id`) ON DELETE CASCADE
...
INSERT INTO `order_menu_tb` VALUES (1,'[{\"count\": 3, \"price\": 5000, \"menuId\": 1, \"menuName\": \"음식점 1의 메뉴 1\"}, {\"count\": 3, \"price\": 7000, \"menuId\": 3, \"menuName\": \"음식점 1의 메뉴 3\"}, {\"count\": 3, \"price\": 40000, \"menuId\": 10, \"menuName\": \"족발 (大)자\"}]'),(2,'[{\"count\": 3, \"price\": 10000, \"menuId\": 4, \"menuName\": \"음식점 2의 메뉴1\"}, {\"count\": 1, \"price\": 15000, \"menuId\": 5, \"menuName\": \"음식점 2의 메뉴3\"}, {\"count\": 4, \"price\": 2000, \"menuId\": 11, \"menuName\": \"불고기버거\"}, {\"count\": 6, \"price\": 4400, \"menuId\": 12, \"menuName\": \"빅맥\"}]'),(3,'[{\"count\": 1, \"price\": 5000, \"menuId\": 1, \"menuName\": \"음식점 1의 메뉴 1\"}, {\"count\": 2, \"price\": 6000, \"menuId\": 2, \"menuName\": \"음식점 1의 메뉴 2\"}, {\"count\": 6, \"price\": 30000, \"menuId\": 9, \"menuName\": \"족발 (中)자\"}, {\"count\": 1, \"price\": 40000, \"menuId\": 10, \"menuName\": \"족발 (大)자\"}]'),(4,'[{\"count\": 30, \"price\": 2000, \"menuId\": 11, \"menuName\": \"불고기버거\"}]'),(5,'[{\"count\": 4, \"price\": 30000, \"menuId\": 9, \"menuName\": \"족발 (中)자\"}]'),(6,'[{\"count\": 20, \"price\": 2000, \"menuId\": 11, \"menuName\": \"불고기버거\"}]'),(7,'[{\"count\": 5, \"price\": 15000, \"menuId\": 5, \"menuName\": \"음식점 2의 메뉴3\"}, {\"count\": 3, \"price\": 2000, \"menuId\": 11, \"menuName\": \"불고기버거\"}, {\"count\": 6, \"price\": 4400, \"menuId\": 12, \"menuName\": \"빅맥\"}]'),(8,'[{\"count\": 20, \"price\": 30000, \"menuId\": 9, \"menuName\": \"족발 (中)자\"}]'),(9,'[{\"count\": 4, \"price\": 20000, \"menuId\": 8, \"menuName\": \"족발 소자\"}, {\"count\": 6, \"price\": 30000, \"menuId\": 9, \"menuName\": \"족발 (中)자\"}]'),(17,'[{\"count\": 4, \"price\": 2000, \"menuId\": 11, \"menuName\": \"불고기버거\"}, {\"count\": 4, \"price\": 4400, \"menuId\": 12, \"menuName\": \"빅맥\"}]'),(20,'[{\"count\": 10, \"price\": 4400, \"menuId\": 12, \"menuName\": \"빅맥\"}]'),(24,'[{\"count\": 2, \"price\": 7000, \"menuId\": 3, \"menuName\": \"음식점 1의 메뉴 3\"}]'),(25,'[{\"count\": 6, \"price\": 2000, \"menuId\": 11, \"menuName\": \"불고기버거\"}]');
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 구매 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_tb` VALUES (1,1,12,'16','2023-11-08','서울 종로구 북촌로 31-4','북촌',3055),(2,2,12,'10','2023-11-11','부산 강서구 가달1로 7','강서구',46729),(3,1,7,'16','2023-11-11','부산 강서구 경등중앙길 140','부산주소테스트',46717),(4,2,7,'17','2023-11-09','서울 강남구 가로수길 5','강남 가로수길',6035),(5,1,7,'14','2023-11-09','부산 동래구 구만덕로 172','',47718),(6,2,7,'6','2023-11-09','부산 강서구 경등중앙길 140','부산주소테스트',46717),(7,2,7,'6','2023-11-09','부산 강서구 경등중앙길 140','부산주소테스트',46717),(8,1,7,'16','2023-11-08','부산 수영구 감포로 2','시간 테스트',48277),(9,1,7,'14','2023-11-09','대전 동구 대전로 387','대전',34694),(17,2,7,'6','2023-11-14','부산 해운대구 달맞이길 30','엘시티 5010호',48099),(20,2,7,'8','2023-11-15','대전 동구 대전로 387','대전',34694),(24,1,7,'17','2023-11-10','부산 해운대구 달맞이길 30','엘시티 5010호',48099),(25,2,7,'19','2023-11-11','부산 해운대구 달맞이길 30','엘시티 5010호',48099);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='파트너 회원 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payment_tb` (
  ...
  `food_id` int NOT NULL COMMENT '음식점 참조키',
  `payment_total_price` int NOT NULL COMMENT '총 구매 금액',
  `payment_order_state` varchar(15) DEFAULT NULL,
  `payment_day` date DEFAULT NULL,
  `payment_delivery_price` int DEFAULT NULL,
  `payment_menu_total_price` int DEFAULT NULL,
  PRIMARY KEY (`payment_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='결제 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment_tb` VALUES (1,1,1,159000,'주문접수대기중','2023-11-06',NULL,NULL),(2,2,2,82400,'주문접수대기중','2023-11-06',NULL,NULL),(3,3,1,240000,'주문접수','2023-11-06',NULL,NULL),(4,4,2,63000,'주문접수대기중','2023-11-06',NULL,NULL),(5,5,1,123000,'주문접수대기중','2023-11-07',NULL,NULL),(6,6,2,43000,'주문접수대기중','2023-11-07',NULL,NULL),(7,7,2,110400,'주문접수대기중','2023-11-07',NULL,NULL),(8,8,1,603000,'주문접수대기중','2023-11-07',NULL,NULL),(9,9,1,263000,'주문접수대기중','2023-11-09',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='음식점 등록 전 임시 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pending_food_tb` VALUES (2,1,3,'귀족향 동래점',NULL,11,12,30000,3000,'부산','부산 동래구 미남로 11','귀족향 동래점',47845,1,'APPROVED','동래구'),(3,2,2,'맥도날드 서면점',NULL,0,24,10000,3000,'부산','부산 부산진구 중앙대로692번길 33','맥도날드 서면3호점',47295,3,'APPROVED','부산진구'),(9,3,2,'롯데리아 롯데마트 동래점',NULL,10,22,10000,3000,'부산','부산 동래구 중앙대로 1393','롯데리아 롯데마트 동래점',47727,2,'APPROVED','동래구'),(10,4,5,'각방',NULL,11,20,12000,5000,'부산','부산 부산진구 동천로107번길 12-5','각방',47246,4,'APPROVED','부산진구'),(14,5,5,'페이센동',NULL,11,20,15000,3000,'부산','부산 부산진구 서전로46번길 6','페이센동 전포본점',47293,6,'APPROVED','부산진구');
...
-- Dump completed on 2023-11-13  9:18:52
