...
INSERT INTO `authority_tb` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1),(5,5,1),(6,6,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='구매 메뉴 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_menu_tb` VALUES (1,8,1,1),(2,8,2,1),(3,8,3,1),(4,9,1,2),(5,9,2,1),(6,9,3,2),(7,10,1,3),(8,10,2,3),(9,10,3,3),(10,11,4,10),(11,11,5,10),(12,12,1,9),(13,12,2,5),(14,12,3,4);
...
INSERT INTO `order_tb` VALUES (1,1,5,'15','2023-10-18'),(2,1,5,'21','2023-10-19'),(3,1,5,'15','2023-10-18'),(4,1,5,'15','2023-10-20'),(5,1,5,'20','2023-10-20'),(6,2,5,'13','2023-10-18'),(7,2,5,'13','2023-10-18'),(8,2,5,'13','2023-10-18'),(9,1,5,'14','2023-10-19'),(10,1,5,'15','2023-10-19'),(11,2,5,'16','2023-10-20'),(12,1,6,'12','2023-10-24');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='결제 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment_tb` VALUES (1,11,2,255000),(2,12,1,106000);
...
INSERT INTO `user_address_tb` VALUES (1,2,'경북 안동시 강남1길 49','테스트3',36751),(2,2,'경북 경주시 남산순환로 12-5','테스트2',38174),(4,2,'서울 강남구 가로수길 5','강남살기',6035),(5,3,'부산 사상구 가야대로 1','사직운동장',46990),(6,6,'서울 용산구 남산공원길 123','테스트 변경',4340);
...
-- Dump completed on 2023-10-19  4:23:29
