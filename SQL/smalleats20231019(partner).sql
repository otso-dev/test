...
INSERT INTO `authority_tb` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1),(5,5,1),(6,6,1),(7,7,1);
...
CREATE TABLE `partner_user_tb` (
  ...
  `partner_user_password` varchar(20) NOT NULL COMMENT '파트너 회원 비밀번호',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='파트너 회원 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_address_tb` VALUES (1,2,'경북 안동시 강남1길 49','테스트3',36751),(2,2,'경북 경주시 남산순환로 12-5','테스트2',38174),(4,2,'서울 강남구 가로수길 5','강남살기',6035),(5,3,'부산 사상구 가야대로 1','사직운동장',46990),(6,6,'경기 성남시 분당구 대왕판교로 477','판교에서 살아보기',13480),(7,7,'경기 성남시 분당구 내정로 54','분당구',13607);
...
-- Dump completed on 2023-10-19 18:00:58
