...
INSERT INTO `authority_tb` VALUES (1,1,1,NULL),(2,2,1,NULL),(3,3,1,NULL),(4,4,1,NULL),(5,5,1,NULL),(6,6,1,NULL),(7,7,1,NULL),(8,8,1,NULL),(9,0,2,1),(10,0,2,NULL),(11,0,2,3),(12,0,2,4),(13,0,2,5),(16,9,3,0),(17,10,3,0),(18,11,3,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='배달 가능 구역';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `food_delivery_tb` VALUES (1,1,'동래구'),(2,1,'사상구'),(3,1,'남구'),(4,1,'북구'),(5,1,'해운대구'),(6,2,'수영구'),(7,2,'해운대구'),(8,2,'연제구'),(9,3,'기장군'),(10,3,'사상구'),(11,3,'수영구'),(12,0,'동래구'),(13,1,'수영구'),(14,1,'중구'),(15,2,'기장군'),(16,2,'북구');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='구매 메뉴 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_menu_tb` VALUES (1,1,4,1),(2,1,5,1),(3,1,11,2),(4,1,12,2),(5,2,8,6),(6,2,9,6),(7,3,6,6),(8,3,7,10),(9,4,9,6),(10,4,10,7),(11,5,11,20),(12,6,6,6),(13,6,7,5);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 구매 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_tb` VALUES (1,2,8,'11','2023-10-27'),(2,1,8,'23','2023-10-28'),(3,3,8,'17','2023-10-31'),(4,1,7,'19','2023-10-27'),(5,2,7,'11','2023-10-27'),(6,3,7,'19','2023-10-28');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='결제 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment_tb` VALUES (1,1,2,40800),(2,2,1,303000),(3,3,3,374000),(4,4,1,463000),(5,5,2,43000),(6,6,3,249000);
...
-- Dump completed on 2023-10-25 14:38:39
