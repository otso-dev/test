...
INSERT INTO `category_tb` VALUES (1,'족발'),(2,'패스트푸드'),(3,'한식'),(4,'중식'),(5,'일식'),(6,'족발');
...
INSERT INTO `food_tb` VALUES (1,3,'귀족향 동래점',NULL,'11','12','30000','3000','부산','부산 동래구 미남로 11','귀족향 동래점',47845,'동래구'),(2,2,'맥도날드 서면점',NULL,'0','24','10000','3000','부산','부산 부산진구 중앙대로692번길 33','맥도날드 서면3호점',47295,'부산진구');
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='메뉴 구매 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_tb` VALUES (1,1,12,'16','2023-11-08','서울 종로구 북촌로 31-4','북촌',3055),(2,2,12,'10','2023-11-11','부산 강서구 가달1로 7','강서구',46729),(3,1,7,'16','2023-11-11','부산 강서구 경등중앙길 140','부산주소테스트',46717),(4,2,7,'17','2023-11-09','서울 강남구 가로수길 5','강남 가로수길',6035),(5,1,7,'14','2023-11-09','부산 동래구 구만덕로 172','',47718),(6,2,7,'6','2023-11-09','부산 강서구 경등중앙길 140','부산주소테스트',46717),(7,2,7,'6','2023-11-09','부산 강서구 경등중앙길 140','부산주소테스트',46717),(8,1,7,'16','2023-11-08','부산 수영구 감포로 2','시간 테스트',48277),(9,1,7,'14','2023-11-09','대전 동구 대전로 387','대전',34694),(17,2,7,'6','2023-11-14','부산 해운대구 달맞이길 30','엘시티 5010호',48099);
...
INSERT INTO `pending_food_tb` VALUES (2,1,3,'귀족향 동래점',NULL,11,12,30000,3000,'부산','부산 동래구 미남로 11','귀족향 동래점',47845,1,'APPROVED','동래구'),(3,2,2,'맥도날드 서면점',NULL,0,24,10000,3000,'부산','부산 부산진구 중앙대로692번길 33','맥도날드 서면3호점',47295,3,'APPROVED','부산진구'),(9,3,2,'롯데리아 롯데마트 동래점',NULL,10,22,10000,3000,'부산','부산 동래구 중앙대로 1393','롯데리아 롯데마트 동래점',47727,2,'PENDING','동래구'),(10,4,5,'각방',NULL,11,20,12000,5000,'부산','부산 부산진구 동천로107번길 12-5','각방',47246,4,'PENDING','부산진구'),(14,5,5,'페이센동',NULL,11,20,15000,3000,'부산','부산 부산진구 서전로46번길 6','페이센동 전포본점',47293,6,'PENDING','부산진구');
...
-- Dump completed on 2023-11-09 18:02:01
