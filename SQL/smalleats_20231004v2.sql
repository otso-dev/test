...
CREATE TABLE `user_address_tb` (
  ...
  `user_id` int NOT NULL,
  `user_address_sido` varchar(100) NOT NULL,
  `user_address_sigungu` varchar(100) NOT NULL,
  `user_roadname` varchar(100) NOT NULL,
  `user_zonecode` int NOT NULL,
...
INSERT INTO `user_tb` VALUES (1,'jsh','test@testmail.com','$2a$10$ksJpwLxBRfjotecrXpo5Ku9vs0slhZD8Rq/My64eDBaNYHrn8BlTG','010-1111-1111',NULL,NULL),(2,'홍길동','test2@testemail.com','$2a$10$cSFHI2fAHooMHXyfTIyTpOBPU8O4lrfJ3lW5m7VmN/eaAZFnohhE6','010-1111-1111',NULL,NULL);
...
-- Dump completed on 2023-10-04 18:03:17
