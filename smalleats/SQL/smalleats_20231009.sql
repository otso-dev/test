...
CREATE TABLE `address_tb` (
  ...
  `address_sido` varchar(45) NOT NULL COMMENT '도시이름',
  `address_sigungu` varchar(45) NOT NULL COMMENT '시/군/구',
  `road_name` varchar(45) NOT NULL COMMENT '도로명 주소',
...
-- Dump completed on 2023-10-10  3:30:19
